...
export default function PlanetScaleLanding() {
  ...
  const features = [
    {
      ...
      description:
        "Generate scroll-stopping posts, stories, and videos that get your field service business noticed across all social platforms.",
    ...
    },
    {
      ...
      description:
        "Track which posts drive the most calls, bookings, and revenue with detailed social media ROI insights.",
    ...
    },
    {
      ...
      description:
        "Schedule and publish content across Instagram, Facebook, TikTok, and YouTube from one powerful dashboard.",
  ...
  const comparisonData = {
    "AI & Automation": {
      "Content Generation": {
        fieldflux: "✓ AI-Powered",
        competitor: "✗ Manual only",
      },
      "Lead Scoring": {
        fieldflux: "✓ Smart algorithms",
        competitor: "✓ Basic scoring",
      },
      "Review Management": {
        fieldflux: "✓ Automated responses",
        competitor: "✗ Manual replies",
      },
    },
    "Marketing Tools": {
      "Landing Page Builder": {
        fieldflux: "✓ AI-Generated",
        competitor: "✓ Template-based",
      },
      "SEO Optimization": {
        fieldflux: "✓ Real-time insights",
        competitor: "✓ Basic reports",
      },
      "Social Media Management": {
        fieldflux: "✓ Multi-platform",
        competitor: "✓ Limited platforms",
      },
    },
    "Analytics & Insights": {
      "Performance Tracking": {
        fieldflux: "✓ Real-time dashboard",
        competitor: "✓ Weekly reports",
      },
      "ROI Measurement": {
        fieldflux: "✓ Advanced attribution",
        competitor: "✓ Basic tracking",
      },
      "Competitive Analysis": {
        fieldflux: "✓ Market insights",
  ...
  const testimonials = [
    {
      ...
      logo: "EH",
      quote:
        "Our Instagram went from 200 to 15K followers in 6 months! FieldFlux's content strategy turned us into the go-to HVAC company in our city.",
      author: "Sarah Chen",
      role: "Marketing Director",
      rating: 5,
      metric: "Exponential follower growth",
    },
    {
      company: "Apex Plumbing",
      logo: "AP",
      quote:
        "We're booked 3 months out thanks to our ability to post across multiple plaforms in a single click! FieldFlux helped us create content that actually converts followers into paying customers.",
    ...
    },
    {
      ...
      logo: "UL",
      quote:
        "Social media felt impossible until FieldFlux. Now we're the most followed landscaper in our market and our DMs are full of project requests.",
      author: "Taylor Kim",
  ...
  return (
    <div className="min-h-screen fx-hills text-gray-900 overflow-hidden">
      ...
      <section className="relative py-20 md:py-28">
        <div
          className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-br from-orange-400/10 to-yellow-400/10 rounded-full blur-3xl animate-pulse"
          style={{ backgroundColor: "var(--fx-sun-400)", opacity: 0.1 }}
        />
        <div
          className="absolute bottom-20 right-10 w-64 h-64 bg-gradient-to-br from-green-400/10 to-teal-400/10 rounded-full blur-3xl animate-pulse delay-1000"
          style={{ backgroundColor: "var(--fx-grass-300)", opacity: 0.15 }}
        />

        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          <AnimatedElement>
            <div
              className="mb-8 inline-flex items-center gap-2 px-4 py-2 rounded-full text-white font-bold shadow-lg transition-all"
          ...
          <AnimatedElement delay={200}>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold mb-8 leading-tight">
              ...
              <br />
              <span style={{ color: "var(--fx-orange-600)" }}>
          ...
          <AnimatedElement delay={400}>
            <p className="text-xl md:text-2xl text-gray-700 mb-12 max-w-4xl mx-auto leading-relaxed font-medium">
              Create viral content, boost engagement, and grow your field
              service business with AI-powered social media marketing. Built
              specifically for HVAC, plumbing, electrical, and landscaping
              professionals who want to dominate their local market.
            </p>
          </AnimatedElement>
          ...
          <AnimatedElement delay={600}>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              ...
              <button
                className="inline-flex items-center gap-3 px-10 py-4 text-lg font-bold border-2 rounded-lg shadow-xl hover:shadow-2xl transition-all bg-white/90 backdrop-blur-sm"
                style={{
                  borderColor: "var(--fx-navy-900)",
                  color: "var(--fx-navy-900)",
                }}
                onMouseOver={(e) =>
                  (e.currentTarget.style.backgroundColor = "var(--fx-mint-50)")
                }
                onMouseOut={(e) =>
                  (e.currentTarget.style.backgroundColor =
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 items-center justify-items-center">
            {[
              ...
              },
              {
                ...
                style: { backgroundColor: "var(--fx-sky-700)" },
              },
              {
                name: "TikTok",
                color: "from-navy-700 to-navy-900",
                style: { backgroundColor: "var(--fx-navy-900)" },
              },
              {
                name: "YouTube",
                color: "from-grass-600 to-grass-700",
                style: { backgroundColor: "var(--fx-grass-700)" },
              },
            ].map((platform, i) => (
              <AnimatedElement key={platform.name} delay={i * 100}>
                <div
                  className="text-lg font-bold text-white px-8 py-4 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:scale-110"
          ...
          <AnimatedElement>
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-6xl font-extrabold mb-6">
                Create Content That{" "}
                <span style={{ color: "var(--fx-orange-600)" }}>Converts</span>
              </h2>
              <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium">
                Stop posting and praying. Every feature is designed to turn your
                social media presence into a lead-generating machine for your
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((feature, i) => (
              <AnimatedElement key={i} delay={i * 200}>
                <div
                  className="bg-white border border-gray-200 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 h-full transform hover:scale-105 fx-grain"
          ...
          <AnimatedElement>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                Don't just take our word for it. Here's how FieldFlux stacks up
                        ...
                        >
                          {i === 0 && (
                            <td
                              ...
                              className="p-4 font-semibold text-blue-600 border-r border-gray-200 align-top"
                            >
                              {section}
                            </td>
                          )}
                          <td className="p-4 border-r border-gray-200 font-medium text-slate-700">
                            {feature}
                          </td>
                          <td className="p-4 border-r border-gray-200 text-center">
                            <span className="text-green-600 font-medium">
                              {comparison.fieldflux}
                            </span>
                          </td>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <AnimatedElement>
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-6xl font-extrabold mb-6">
                Real Results from{" "}
                <span style={{ color: "var(--fx-orange-600)" }}>
                  Real Field Service Pros
                </span>
              </h2>
              <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium">
                These field service pros went from social media struggles to
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, i) => (
              <AnimatedElement key={i} delay={i * 200}>
                <div
                  className="bg-white border rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500 h-full transform hover:scale-105 p-8 fx-grain"
                  style={{
                ...
                >
                  <div className="p-0">
                    ...
                    <div
                      className="text-white px-4 py-2 rounded-full text-sm font-bold mb-6 inline-block"
                      style={{ backgroundColor: "var(--fx-orange-600)" }}
                    >
                      {testimonial.metric}
                    </div>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, var(--fx-navy-900), var(--fx-navy-700))",
        }}
      >
        ...
        <div className="absolute inset-0">
          <div
            ...
            style={{ backgroundColor: "var(--fx-orange-600)", opacity: 0.2 }}
          />
          <div
            className="absolute bottom-10 right-10 w-40 h-40 rounded-full blur-2xl animate-pulse delay-1000"
            style={{ backgroundColor: "var(--fx-sun-400)", opacity: 0.15 }}
          />
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <AnimatedElement delay={200}>
            <p className="text-xl md:text-2xl mb-12 text-white/90 leading-relaxed font-medium max-w-3xl mx-auto">
              Join 10,000+ field service professionals who've transformed their
              social media presence into a lead-generating machine.
            </p>
          </AnimatedElement>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-slate-600 mb-4 leading-relaxed">
                Intelligent marketing automation for field service
                professionals.
              </p>
            </div>
