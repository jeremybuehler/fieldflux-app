...
import { ArrowLeft, Globe, FileText, Edit, TrendingUp, Users, Calendar, Clock } from "lucide-react";
          ...
          <div className="p-4 lg:p-6 pt-16 lg:pt-6">
            <div className="mb-6 lg:mb-8">
              ...
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h1 className="text-xl lg:text-2xl font-bold text-gray-900">Website Management</h1>
                  <p className="text-gray-600 text-sm lg:text-base">Manage your website content and performance</p>
                </div>
              </div>
            </div>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                      <div className="text-center p-3 bg-blue-50 rounded-lg">
                        ...
                        <div className="text-sm text-blue-800">Active Pages</div>
                      </div>
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">"5 Tips for Energy-Efficient Cooling"</p>
                    ...
                    <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">"Commercial Installation Success Story"</p>
