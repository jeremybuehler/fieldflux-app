      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center space-x-3 mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">FieldFlux</h1>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="border-2 border-transparent hover:shadow-lg transition-all duration-300 bg-white rounded-xl p-6">
        ...
        <div className="text-center px-2">
          <div className="max-w-2xl mx-auto rounded-xl p-6 lg:p-8" style={{backgroundColor: 'var(--bg-elevated)', border: '2px solid var(--border)'}}>
