  ...
  const steps: OnboardingStep[] = [
    ...
    },
    {
      ...
      component: (
        <div className="space-y-6">
          <div>
            <Label className="text-sm sm:text-base font-medium">Primary Goals (Select all that apply)</Label>
            <div className="mt-2 sm:mt-3 space-y-2 sm:space-y-3">
              {[
                ...
                <div key={goal} className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor={goal} className="text-xs sm:text-sm font-normal cursor-pointer">{goal}</Label>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            <Label className="text-sm sm:text-base font-medium">Current Challenges (Select all that apply)</Label>
            <div className="mt-2 sm:mt-3 space-y-2 sm:space-y-3">
              {[
                ...
                <div key={challenge} className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor={challenge} className="text-xs sm:text-sm font-normal cursor-pointer">{challenge}</Label>
                </div>
              ))}
            </div>
          </div>
    ...
    },
    {
      ...
      component: (
        <div className="space-y-6">
          <div>
            <Label className="text-sm sm:text-base font-medium">Current Marketing Activities</Label>
            <div className="mt-2 sm:mt-3 space-y-2 sm:space-y-3">
              {[
                ...
                <div key={activity} className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor={activity} className="text-xs sm:text-sm font-normal cursor-pointer">{activity}</Label>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            <Label className="text-sm sm:text-base font-medium">Social Media Platforms</Label>
            <div className="mt-2 sm:mt-3 space-y-2 sm:space-y-3">
              {[
                'Facebook',
                'Instagram',
                ...
                <div key={platform} className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor={platform} className="text-xs sm:text-sm font-normal cursor-pointer">{platform}</Label>
                </div>
              ))}
            </div>
          </div>
          ...
          {aiRecommendations.length === 0 ? (
            ...
            <div className="space-y-6">
              <div className="text-center px-2">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-2">Your Personalized Marketing Plan</h3>
                        ...
                        <div className="flex items-start space-x-2 sm:space-x-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-col sm:flex-row sm:items-center space-y-1 sm:space-y-0 sm:space-x-2 mb-2">
                              <h4 className="font-semibold text-gray-900 text-sm sm:text-base leading-tight">{rec.title}</h4>
                              <Badge variant={rec.priority === 'high' ? 'destructive' : rec.priority === 'medium' ? 'default' : 'secondary'} className="text-xs self-start sm:self-auto">
                                {rec.priority} priority
                              </Badge>
                            </div>
                            <p className="text-xs sm:text-sm text-gray-600 mb-3 leading-relaxed">{rec.description}</p>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-4 sm:p-6">
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <h4 className="font-semibold text-gray-900 text-sm sm:text-base">Next Steps</h4>
                </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      ...
      <header className="bg-white/80 backdrop-blur-sm border-b border-gray-200">
        <div className="max-w-2xl lg:max-w-4xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="flex justify-between items-center h-14 sm:h-16">
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <div>
                <span className="text-base sm:text-xl font-bold text-gray-900">FieldFlux Onboarding</span>
                <div className="text-xs text-gray-500 font-medium hidden sm:block">Personalized Setup Experience</div>
              </div>
            </div>
      ...
      <div className="max-w-2xl lg:max-w-4xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8">
        {/* Progress Bar */}
        ...
        {/* Step Navigation */}
        <div className="mb-4 sm:mb-6 lg:mb-8">
          <div className="flex justify-center space-x-2 sm:space-x-4 overflow-x-auto pb-2 px-2">
            {steps.map((step, index) => (
              <div
                key={step.id}
                className={`flex items-center space-x-1 sm:space-x-2 px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg whitespace-nowrap text-center min-w-0 flex-shrink-0 ${
                  index === currentStep
        ...
        {/* Main Content */}
        <Card className="mb-4 sm:mb-6 lg:mb-8 border-0 shadow-lg">
          <CardHeader className="text-center px-3 sm:px-6 pt-4 sm:pt-6">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-100 to-purple-100 rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
              {currentStepData.icon}
            </div>
            <CardTitle className="text-lg sm:text-xl lg:text-2xl px-1 sm:px-0">{currentStepData.title}</CardTitle>
            <p className="text-gray-600 text-sm sm:text-base px-1 sm:px-0">{currentStepData.description}</p>
          </CardHeader>
