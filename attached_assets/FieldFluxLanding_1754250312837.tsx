...
import { CheckCircle, Star, Zap, Users, BarChart3, Settings, TrendingUp, ArrowRight, Play, Shield, Clock, Target } from "lucide-react";
import fieldFluxLogo from "figma:asset/d14cc83936e612aab13d1a899f4b7aa20bb56e6a.png";
import { ImageWithFallback } from "./figma/ImageWithFallback";

export function FieldFluxLanding() {
  return (
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Button size="sm" className="bg-slate-800 hover:bg-slate-700">Get Started</Button>
            </div>
          </div>
        </div>
      </nav>
